          ...
          <div className="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-8 gap-3 md:gap-4">
            <div className="space-y-1 col-span-2">
              ...
              <input
                ...
                className="w-full px-3 py-2 md:px-4 md:py-2.5 bg-surface border border-border rounded-xl focus:outline-none focus:border-primary/50 focus:ring-2 focus:ring-primary/10 transition-all text-sm md:text-base font-bold min-h-[44px]"
              />
            </div>
            <div className="space-y-1 col-span-2">
              <label className="text-[10px] md:text-xs font-bold text-muted-foreground uppercase tracking-wider">
            ...
            <div className="space-y-1 col-span-1">
              ...
              <select
                ...
                onChange={handleChange}
                className="w-full px-3 py-2 md:px-4 md:py-2.5 bg-surface border border-border rounded-xl focus:outline-none focus:border-primary/50 appearance-none text-sm min-h-[44px]"
              >
                {[
                  "C",
                  "C#",
            ...
            <div className="space-y-1 col-span-1">
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="Std"
                className="w-full px-3 py-2 md:px-4 md:py-2.5 bg-surface border border-border rounded-xl focus:outline-none focus:border-primary/50 focus:ring-2 focus:ring-primary/10 transition-all text-sm min-h-[44px]"
              />
            </div>
            <div className="space-y-1 col-span-1">
              <label className="text-[10px] md:text-xs font-bold text-muted-foreground uppercase tracking-wider">
            ...
            <div className="space-y-1 col-span-2 md:col-span-4 xl:col-span-8">
              <label className="text-[10px] md:text-xs font-bold text-muted-foreground uppercase tracking-wider">
                Tags
              </label>
              <input
